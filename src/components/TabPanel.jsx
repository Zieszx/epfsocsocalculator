      ...
      <div className="grid grid-cols-4 gap-1">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center justify-center gap-1.5 px-2 py-2.5 rounded-lg text-xs sm:text-sm font-medium transition-all cursor-pointer ${
              activeTab === tab.id
